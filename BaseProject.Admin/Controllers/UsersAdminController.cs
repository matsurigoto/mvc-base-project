...
{
    public class UsersAdminController : CoreBaseController
    {
        ...
        public async Task<ActionResult> Edit(EditUserViewModel editUser, params string[] selectedRole)
        {
            if (ModelState.IsValid)
            {
                ...
                {
                    UserManager.RemovePassword(editUser.Id);
                    UserManager.AddPassword(editUser.Id, editUser.Password);
                }
