...
namespace BaseProject.Admin.DI.Autofac.Modules
{
        ...
        : global::Autofac.Module
    {
        protected override void Load(ContainerBuilder builder)
        {
            ...
            string[] includeAssembliesForScan = new string[] { "BaseProject.Admin" };
            ...
            builder.RegisterType<CustomAclModule>()
                .Named<IAclModule>("customAclModule");
            ...
            builder.RegisterType<CompositeAclModule>()
                ...
                .WithParameter(
                    ...
                    (p, c) => new[]
                        {
                            c.ResolveNamed<IAclModule>("customAclModule")
                        });
            ...
            builder.RegisterType<ReservedAttributeNameProvider>()
                ...
                .WithParameter("attributesToIgnore", new string[]{"Resource", "Operation"});
